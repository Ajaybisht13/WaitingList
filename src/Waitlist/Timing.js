import { Text, View, Pressable, Image, Dimensions, Modal, Platform, BackHandler } from 'react-native'
                                    ...
                                    <View style={{ flexDirection: "row", flexWrap: "wrap", marginLeft: -10, marginTop: 5 }}>
                                        {
                                            this.state.day.map((itme) =>
                                                <Pressable
                                                    ...
                                                    <CheckBox
                                                        style={{ flex: 1, padding: 5, width: 20, height: 20 }}
                                                    ...
                                                    />
                                                    <Text style={{ marginTop: 10, fontFamily: "Poppins-Medium", fontSize: this.state.width < 769 ? 12 : 18, marginLeft: this.state.width < 769 ? 10 : 10 }}>{itme.day}</Text>
                                                </Pressable>)
                                        }
                            ...
                            this.state.showsaveDays == true ? (<Pressable
                                ...
                                <Text style={{ fontSize: 15, color: '#fff', fontFamily: 'Poppins-SemiBold' }}>Save</Text>
                                    ...
                                    <Pressable
                                        ...
                                        style={{ backgroundColor: '#067655', borderRadius: 60, paddingVertical: 5, paddingHorizontal: 25, width: this.state.width < 769 ? 90 : 100, marginTop: 10, alignSelf: 'flex-end' }}>
                                        <Text style={{ fontSize: 15, color: '#fff', fontFamily: 'Poppins-SemiBold' }}>Save</Text>
                                    </Pressable>
                                </View>
                                <View>
                                        ...
                                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                            ...
                                            >
                                                <Image
                                                    ...
                                                    style={{ width: this.state.width < 769 ? 36 : 45, height: this.state.width < 769 ? 36 : 45 }}
                                                />
                                            </Pressable>
                                        </View>
                                        {
                                                        ...
                                                        <View style={{ flexDirection: "row", marginTop: 10, alignItems: "center", justifyContent: "space-between", marginRight: 15 }}>
                                                            <View style={{}}>
                                                                <View style={{ flexDirection: 'row', alignItems: "center" }}>
                                                                    <Pressable
                                                                        style={{ backgroundColor: "#EDEDF4", padding: 10, width: this.state.width < 769 ? 85 : 100, borderRadius: 10 }}
                                                                    ...
                                                                    <Pressable style={{ backgroundColor: "#EDEDF4", padding: 10, width: this.state.width < 769 ? 85 : 100, borderRadius: 10 }}
                                                                    // onPress={() => this.setState({ closetime: true })}
                                                                    >
                                                            ...
                                                            <View style={{ marginLeft: 10, flexDirection: "row" }}>
                                                                ...
                                                                >
                                                                    <Image
                                                                        ...
                                                                        style={{ width: this.state.width < 769 ? 25 : 35, height: this.state.width < 769 ? 25 : 35 }}
                                                                    />
                                                                </Pressable>
                                                                ...
                                                                >
                                                                    <Image
                                                                        ...
                                                                        style={{ width: this.state.width < 769 ? 20 : 30, height: this.state.width < 769 ? 25 : 35 }}
                                                                    />
                                                                </Pressable>
                                                            </View>
                                                        </View>
                            ...
                            >
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        backgroundColor: "white",
                                        width: this.state.width < 769 ? '100%' : '100%', height: 'auto', padding: 20,
                                        shadowColor: "#000",
                                        shadowOffset: {
                                            width: 0,
                                            height: 9,
                                            ...
                                            <View style={{ flexDirection: 'row', marginLeft: -7, marginTop: 10 }}>
                                                {
                                                    this.state.day1.map((itme) =>
                                                        <Pressable
                                                            ...
                                                            style={{ alignItems: "center", borderWidth: 1, width: this.state.width < 769 ? 40 : 60, height: this.state.width < 769 ? 40 : 60, borderRadius: this.state.width < 769 ? 20 : 30, marginLeft: 10, marginTop: 10, backgroundColor: itme.isActive == false ? "grey" : itme.atSelection == true ? "#067655" : null }}>
                                                            <Text style={{ marginTop: this.state.width < 769 ? 10 : 15, fontFamily: "Poppins-Medium", color: itme.isActive == false ? "#fff" : itme.atSelection == true ? "#fff" : "#000" }}>{itme.day}</Text>
                                                        </Pressable>)
                                                }
                                            </View>
                                        </View>
